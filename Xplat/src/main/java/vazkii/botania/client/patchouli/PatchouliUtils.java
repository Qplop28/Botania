...
public class PatchouliUtils {
	 ...
	 */
	public static <T extends Recipe<C>, C extends Container> T getRecipe(Level level, RecipeType<T> type, Identifier id) {
		Map<Identifier, T> map = BotaniaRecipeTypes.getRecipes(level, type);
		T r = map.get(id);
		if (r != null) {
			return r;
		}
		...
		r = map.get(new Identifier("crafttweaker", "autogenerated/" + id.getNamespace() + "." + id.getPath()));
		if (r != null) {
			return r;
		}
	...
	public static <T extends Recipe<C>, C extends Container> List<T> getRecipeGroup(RecipeType<T> type, String group) {
		Map<Identifier, T> map = BotaniaRecipeTypes.getRecipes(Minecraft.getInstance().level, type);
