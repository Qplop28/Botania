...
public class ItemModelProvider implements DataProvider {
	...
	private static final ModelTemplate GENERATED_1 = new ModelTemplate(Optional.of(new Identifier("item/generated")), Optional.empty(), TextureSlot.LAYER0, LAYER1);
	private static final ModelTemplate GENERATED_2 = new ModelTemplate(Optional.of(new Identifier("item/generated")), Optional.empty(), TextureSlot.LAYER0, LAYER1, LAYER2);
	private static final ModelTemplate HANDHELD_1 = new ModelTemplate(Optional.of(new Identifier("item/handheld")), Optional.empty(), TextureSlot.LAYER0, LAYER1);
	private static final ModelTemplate HANDHELD_3 = new ModelTemplate(Optional.of(new Identifier("item/handheld")), Optional.empty(), TextureSlot.LAYER0, LAYER1, LAYER2, LAYER3);
	...
	private static final ModelWithOverrides GENERATED_OVERRIDES = new ModelWithOverrides(new Identifier("item/generated"), TextureSlot.LAYER0);
	private static final ModelWithOverrides GENERATED_OVERRIDES_1 = new ModelWithOverrides(new Identifier("item/generated"), TextureSlot.LAYER0, LAYER1);
	private static final ModelWithOverrides HANDHELD_OVERRIDES = new ModelWithOverrides(new Identifier("item/handheld"), TextureSlot.LAYER0);
	private static final ModelWithOverrides HANDHELD_OVERRIDES_2 = new ModelWithOverrides(new Identifier("item/handheld"), TextureSlot.LAYER0, LAYER1, LAYER2);
	...
	private static void registerItemOverrides(Set<Item> items, BiConsumer<Identifier, Supplier<JsonElement>> consumer) {
		...
		Identifier twigWandBind = ModelLocationUtils.getModelLocation(twigWand, "_bind");
		...
		Identifier dreamwoodWandBind = ModelLocationUtils.getModelLocation(dreamwoodWand, "_bind");
	...
	private static void registerBrewContainerOverrides(BaseBrewItem brewItem, Item emptyItem,
			BiConsumer<Identifier, Supplier<JsonElement>> consumer) {
		OverrideHolder flaskOverrides = new OverrideHolder();
		for (int i = 1; i < brewItem.getSwigs(); i++) {
			Identifier overrideModel = ModelLocationUtils.getModelLocation(brewItem, "_" + i);
