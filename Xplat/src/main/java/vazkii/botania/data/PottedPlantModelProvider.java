...
public class PottedPlantModelProvider implements DataProvider {
	...
	static MultiVariantGenerator createSimpleBlock(Block block, Identifier Identifier) {
		return MultiVariantGenerator.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, Identifier));
	}
